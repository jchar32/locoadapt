...
from utils.processing import filter_signal
...
def mariani(
    filtered_accel, filtered_gyro, midswing: np.ndarray, negpeak_idx: np.ndarray
):
...
def gait_events(
    ...
    # events = mariani(accel_filt, gyr_filt, midswings, negpeak_idx)
    events = {}
    return events
